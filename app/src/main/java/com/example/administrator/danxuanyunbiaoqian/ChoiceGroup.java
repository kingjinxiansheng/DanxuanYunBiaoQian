...
public class ChoiceGroup extends LinearLayout {
    ...
    public void setView(final Context context){
        ...
        for(int i=0;i<row;i++){
            ...
            linearLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 0, 1));
        ...
        if(leftSize != 0){
            ...
            for(int m=0;m<column;m++){
                if(m<leftSize) {
                    ...
                    LayoutParams layoutParamsV = new LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1);
